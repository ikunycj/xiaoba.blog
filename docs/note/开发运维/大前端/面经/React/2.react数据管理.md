...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1e15b888f3bd4a1db8b72259331a4747~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp) 在 React 中，`setState` 是用来更新组件状态的核心 API，其调用和执行原理涉及到多个步骤和机制。下面详细说明其工作原理：
