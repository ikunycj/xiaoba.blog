...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151831.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151840.png)

其中`sdshdr`是头部, `buf`是真实存储用户数据的地方. 另外注意, 从命名上能看出来, 这个数据结构除了能存储二进制数据, 显然是用于设计作为字符串使用的, 所以在buf中, 用户数据后总跟着一个\0. 即图中 `"数据" + "\0"` 是为所谓的buf。

- 如下是**6.0源码中sds相关的结构**：
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151900.png)

通过上图我们可以看到，SDS有五种不同的头部. 其中sdshdr5实际并未使用到. 所以实际上有四种不同的头部, 分别如下:

![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151907.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151917.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151924.png)

整个ziplist在内存中的存储格式如下：

![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151938.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522151945.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522152001.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522152020.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522152033.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522152040.png)

如果我们增加如下两级索引，那么它搜索次数就变成了3次

![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522152046.png)
...
![](https://raw.githubusercontent.com/ikunycj/xiaoba.blog-images/main/note/软件工程/数据库/Redis/2.Redis进阶/img/Pasted image 20240522152056.png)
