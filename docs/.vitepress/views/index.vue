<template>
    <div class="home flex h-screen w-screen items-center justify-center">
      <div class="fade-in -mt-10 sm:-mt-40 flex w-screen animate-scale-in-center flex-col px-4 sm:w-[626px]">
        <div
          ...
          <div class="mt-4 flex gap-4">
            ...
            <div @click="gotoGithub"
              class="button button-github relative inline-flex cursor-pointer rounded-full bg-white active:scale-95 items-center">
              <Icon icon="fa:github" class="w-5" />
              Github
            </div>
          </div>
        </div>
...
const gotoGithub = () => {
  window.open('https://github.com/ikunycj', '_blank')
}
</script>
...
.fade-in {
  opacity: 0; /* 初始状态完全透明 */
  animation: fadeIn 2s ease-in-out forwards; /* 2秒渐入动画 */
}
